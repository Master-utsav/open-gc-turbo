...
export default async function Page() {
  ...
  return (
    <div className="h-dvh w-full bg-background overflow-hidden relative flex items-center justify-center px-4">
      ...
      {/* Scroll container — handles small screens gracefully */}
      <div className="relative z-10 w-full max-w-sm overflow-y-auto max-h-full py-8">

        {/* Card */}
        <div className="w-full rounded-2xl border border-border bg-card/80 backdrop-blur-md shadow-2xl p-8 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
